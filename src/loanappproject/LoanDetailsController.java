    ...
    private void loadLoanDetails() {
        ...
        try (Connection conn = DBConnect.getConnection(); PreparedStatement ps = conn.prepareStatement(query)) {
            ...
            if (rs.next()) {
                ...
                interestLabel.setText("Interest: ₦" + String.format("%,.2f", rs.getDouble("total_interest")));
                repaymentLabel.setText("Repayment: ₦" + String.format("%,.2f", rs.getDouble("total_repayment")));
                dateLabel.setText("Date: " + rs.getString("date_requested"));
